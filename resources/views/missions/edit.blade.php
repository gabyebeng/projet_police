...
<div class="container-xl">			    
    <h1 class="app-page-title">{{$mission->nom}}</h1>
    <hr class="mb-4">
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Modification</h3>
            <div class="section-intro">Chisissez la nouvelle equipe pour la mission : <b> {{$mission->nom}} </b></div>
        </div>
        <div class="col-12 col-md-5">
            <div class="app-card app-card-settings shadow-sm p-4">
                
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{route('mission.update', $mission)}}">
                        @csrf
                        @method('PUT')
